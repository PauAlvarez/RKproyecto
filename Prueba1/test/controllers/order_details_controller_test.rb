...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { book_id: @order_detail.book_id, cantidad: @order_detail.cantidad, descuento: @order_detail.descuento, importe: @order_detail.importe, order_id: @order_detail.order_id }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { book_id: @order_detail.book_id, cantidad: @order_detail.cantidad, descuento: @order_detail.descuento, importe: @order_detail.importe, order_id: @order_detail.order_id }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end

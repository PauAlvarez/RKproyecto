...
class FeesControllerTest < ActionController::TestCase
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post :create, fee: { cantidaddinero: @fee.cantidaddinero, fechaestablecida: @fee.fechaestablecida, user_id: @fee.user_id }
    end
  ...
  test "should update fee" do
    patch :update, id: @fee, fee: { cantidaddinero: @fee.cantidaddinero, fechaestablecida: @fee.fechaestablecida, user_id: @fee.user_id }
    assert_redirected_to fee_path(assigns(:fee))
  end
